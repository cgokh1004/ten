			...
			<div>
						...
						<div>
							...
							<dl>
								...
								<dd>
									<select name="purpose">
										<option value="출퇴근"
										<c:if test="${dto.purpose=='출퇴근'}">selected="selected"</c:if>
										>출퇴근</option>
										<option value="통학"
										<c:if test="${dto.purpose=='통학'}">selected="selected"</c:if>
										>통학</option>
										<option value="출장"
										<c:if test="${dto.purpose=='출장'}">selected="selected"</c:if>
										>출장</option>
										<option value="명절"
										<c:if test="${dto.purpose=='명절'}">selected="selected"</c:if>
										>명절(추석,설)</option>
										<option value="고향"
										<c:if test="${dto.purpose=='고향'}">selected="selected"</c:if>
										>고향</option>
										<option value="여행"
										<c:if test="${dto.purpose=='여행'}">selected="selected"</c:if>
										>여행</option>
										<option value="페스티벌"
										<c:if test="${dto.purpose=='페스티벌'}">selected="selected"</c:if>
										>페스티벌</option>
										<option value="스키"
										<c:if test="${dto.purpose=='스키'}">selected="selected"</c:if>
										>스키</option>
										<option value="레저"
										<c:if test="${dto.purpose=='레저'}">selected="selected"</c:if>
										>레저</option>
										<option value="기타"
										<c:if test="${dto.purpose=='기타'}">selected="selected"</c:if>
										>기타</option>
									</select>
								</dd>
							</dl>
					...
					<dl>
						...
						<dd>
							...
							<select name="seat">
								<option value="1"
								<c:if test="${dto.seat=='1'}">selected="selected"</c:if>
								>1명</option>
								<option value="2"
								<c:if test="${dto.seat=='2'}">selected="selected"</c:if>
								>2명</option>
								<option value="3"
								<c:if test="${dto.seat=='3'}">selected="selected"</c:if>
								>3명</option>
								<option value="4"
                               <c:if test="${dto.seat=='4'}">selected="selected"</c:if>
								>4명</option>			
							</select>
					...
					<dl>
						...
						<dd>
							...
							<textarea name = "content" cols="70" rows="20" value="${dto.content }">
								</textarea>
						</dd>
					</dl>
			</div>
