...
<body>
	...
	<table class="table" align="center">
		<tr>
			<th>제목</th>
			<td><input type="text" value="${dto.title }" maxlength="20" name="title" style="margin: 0 auto"></td>
		</tr>
		<tr>
			<th>사진</th>
			<td><input type="file" value="${dto.fnameMF }" name= "fnameMF"></td>
		</tr>
		<tr>
			<th>내용</th>
			<td><textarea name="content"  rows="20" cols="40">${dto.content }</textarea> </td>
		</tr>
		<tr>
			<th>지역</th>
			<td><input type="text" value="${dto.location}" maxlength="20" name="location" style="margin: 0 auto"></td>
		</tr>	
	</table>
		<br>
