		...
		<tr>
			<td colspan="4" style="border-top: 1px solid gray">
				...
				<div align="center"
					...
					<br> <img id="star1" alt="별" src="../images/별0.png"> <img
						id="star2" alt="별" src="../images/별0.png"> <img id="star3"
						alt="별" src="../images/별0.png"> <img id="star4" alt="별"
						src="../images/별0.png"> <img id="star5" alt="별"
						src="../images/별0.png"> <br>
					<br>
				</div>
			</td>
		</tr>
	...
	function find(){
		...
		$("#star1").click(
				function() {
					$("#star1,#star2,#star3,#star4,#star5").attr("src",
							"../images/별0.png"), $(this).attr("src",
							"../images/별1.png")
				})
		$("#star2").click(
				function() {
					$("#star1,#star2,#star3,#star4,#star5").attr("src",
							"../images/별0.png"), $("#star1").trigger("click"),
		...
		$("#star3").click(
				function() {
					$("#star1,#star2,#star3,#star4,#star5").attr("src",
							"../images/별0.png"), $("#star1").trigger("click"),
							$("#star2").trigger("click"), $(this).attr("src",
									"../images/별1.png")
				})
		$("#star4").click(
				function() {
					$("#star1,#star2,#star3,#star4,#star5").attr("src",
							"../images/별0.png"), $("#star1").trigger("click"),
							$("#star2").trigger("click"), $("#star3").trigger(
									"click"), $(this).attr("src",
									"../images/별1.png")
				})
		$("#star5").click(
