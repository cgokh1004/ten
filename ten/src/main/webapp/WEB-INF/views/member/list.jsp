...
<%@ page import="spring.model.member.*,java.util.*,spring.model.ten.*"%>
	...
	<DIV class="content">
		...
		<FORM method="POST" action="list">
			<select name="col">
				...
				type="submit" value="검색" /> &emsp;<input type='button'
				value='회원 등록' onclick="location.href='../member/create'">
		</FORM>
	</DIV>
		...
		<TABLE border='1' align='center' width='70%'>
			...
			<TR>
				<TD rowspan='5' width='20%' align="center"><IMG
					src='../storage/${dto.fname}' width='100%'></TD>
				<TH width='20%'>아이디</TH>
			...
			<TR>
				<TH>주소</TH>
				<TD>${dto.address1}<c:if test="${not empty dto.address2}">
    ${dto.address2}
    </c:if>
				</TD>
			</TR>
