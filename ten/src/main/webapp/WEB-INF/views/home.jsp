    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <div class="intro-lead-in">Welcome to 'With Share'</div>
                <div class="intro-heading">Have a niceday!</div>
                <a href="#carpool" class="page-scroll btn btn-xl">more</a>
            </div>
        </div>
    </header>
