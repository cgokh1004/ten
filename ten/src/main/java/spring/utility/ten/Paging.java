...
//	    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
	    ...
	    int _nowPage = (nowGrp-1) * pagePerBlock; // 10개 이전 페이지로 이동 
	    if (nowGrp >= 2){ 
	    	String tempstr = "paginglist?faddress=" + faddress + "&nowPage=" + nowPage;
	      str.append("<span class='span_box_1'><A href='javascript:async("+tempstr+")'>이전</A></span>"); 
	    } 
	    ...
	    for(int i=startPage; i<=endPage; i++){ 
	      ...
	      if (nowPage == i){ 
	        str.append("<span class='span_box_2'>"+i+"</span>"); 
	    	  ...
	    	  String tempstr = "paginglist?faddress=" + faddress + "&nowPage=" + nowPage+i;
	    ...
	    if (nowGrp < totalGrp){ 
	    	String tempstr = "paginglist?faddress=" + faddress + "&nowPage=" + nowPage;
	      str.append("<span class='span_box_1'><A href='javascript:hehehe()'>다음</A></span>"); 
	    } 
	    str.append("</DIV>"); 
